...
function serviceDirectory(baseUrl) {
  return {
    ...
    schemas: {
      listing_intent: `${REPOSITORY}/raw/main/schemas/agent-listing-intent.schema.json`,
      readiness_response: `${REPOSITORY}/raw/main/schemas/listing-readiness-response.schema.json`,
      orbital_prospectus: `${REPOSITORY}/raw/main/schemas/orbital-prospectus.schema.json`
    },
...
1. Read the listing-intent schema: https://raw.githubusercontent.com/Svyable/open-ipo/main/schemas/agent-listing-intent.schema.json
...
5. For a durable public record, submit intents/<agent-slug>.json to https://github.com/Svyable/open-ipo.
